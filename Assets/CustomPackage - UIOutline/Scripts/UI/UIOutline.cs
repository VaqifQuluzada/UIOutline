...
namespace PandaArcade.UIOutline.UI
{
    [RequireComponent(typeof(CanvasRenderer))]
    public class UIOutline : MaskableGraphic
    {
        [SerializeField] private Texture m_Texture;
        [SerializeField][Range(0f, 500f)] private float _outlineWidth = 100f;
        [SerializeField][Range(0f, 500f)] private float _cornerRadius = 50f;
        [SerializeField][Range(1, 20)] private int _cornerSegments = 1;
        [SerializeField][Range(0f, 1f)] private float _mappingBias = 0.5f;
